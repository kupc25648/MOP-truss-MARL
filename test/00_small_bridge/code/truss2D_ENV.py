...
class Game_research04:
    ...
    def _game_modify(self,set_node, set_element, nC_e, actions):
        ...
        if random.random()>=0.5:
            ...
            self.gen_model.model.nodes[1].coord[1] = self.gen_model.model.nodes[6].coord[1]

            self.gen_model.model.nodes[5].coord[1] = self.gen_model.model.nodes[5].coord[1]
            self.gen_model.model.nodes[2].coord[1] = self.gen_model.model.nodes[5].coord[1]

            self.gen_model.model.nodes[4].coord[1] = self.gen_model.model.nodes[4].coord[1]
            self.gen_model.model.nodes[3].coord[1] = self.gen_model.model.nodes[4].coord[1]

            self.gen_model.model.nodes[15].coord[1] = self.gen_model.model.nodes[15].coord[1]
            self.gen_model.model.nodes[8].coord[1] = self.gen_model.model.nodes[15].coord[1]

            self.gen_model.model.nodes[14].coord[1] = self.gen_model.model.nodes[14].coord[1]
            self.gen_model.model.nodes[9].coord[1] = self.gen_model.model.nodes[14].coord[1]

            self.gen_model.model.nodes[13].coord[1] = self.gen_model.model.nodes[13].coord[1]
            self.gen_model.model.nodes[10].coord[1] = self.gen_model.model.nodes[13].coord[1]

            self.gen_model.model.nodes[12].coord[1] = self.gen_model.model.nodes[12].coord[1]
            self.gen_model.model.nodes[11].coord[1] = self.gen_model.model.nodes[12].coord[1]

        else:
            self.gen_model.model.nodes[1].coord[1] = self.gen_model.model.nodes[1].coord[1]
            self.gen_model.model.nodes[6].coord[1] = self.gen_model.model.nodes[1].coord[1]

            self.gen_model.model.nodes[2].coord[1] = self.gen_model.model.nodes[2].coord[1]
            self.gen_model.model.nodes[5].coord[1] = self.gen_model.model.nodes[2].coord[1]

            self.gen_model.model.nodes[3].coord[1] = self.gen_model.model.nodes[3].coord[1]
            self.gen_model.model.nodes[4].coord[1] = self.gen_model.model.nodes[3].coord[1]

            self.gen_model.model.nodes[8].coord[1] = self.gen_model.model.nodes[8].coord[1]
            self.gen_model.model.nodes[15].coord[1] = self.gen_model.model.nodes[8].coord[1]

            self.gen_model.model.nodes[9].coord[1] = self.gen_model.model.nodes[9].coord[1]
            self.gen_model.model.nodes[14].coord[1] = self.gen_model.model.nodes[9].coord[1]

            self.gen_model.model.nodes[10].coord[1] = self.gen_model.model.nodes[10].coord[1]
            self.gen_model.model.nodes[13].coord[1] = self.gen_model.model.nodes[10].coord[1]

            self.gen_model.model.nodes[11].coord[1] = self.gen_model.model.nodes[11].coord[1]
            self.gen_model.model.nodes[12].coord[1] = self.gen_model.model.nodes[11].coord[1]

        # ASSIGN SYMMETRY ELEMENT + ADJUSTMENT
        self.gen_model.model.elements[0].section_no = min(self.gen_model.model.elements[0].section_no,self.gen_model.model.elements[6].section_no)
        self.gen_model.model.elements[6].section_no = min(self.gen_model.model.elements[0].section_no,self.gen_model.model.elements[6].section_no)
        self.gen_model.model.elements[1].section_no = min(self.gen_model.model.elements[1].section_no,self.gen_model.model.elements[5].section_no)
        self.gen_model.model.elements[5].section_no = min(self.gen_model.model.elements[1].section_no,self.gen_model.model.elements[5].section_no)
        self.gen_model.model.elements[2].section_no = min(self.gen_model.model.elements[2].section_no,self.gen_model.model.elements[4].section_no)
        self.gen_model.model.elements[4].section_no = min(self.gen_model.model.elements[2].section_no,self.gen_model.model.elements[4].section_no)
        self.gen_model.model.elements[7].section_no = min(self.gen_model.model.elements[7].section_no,self.gen_model.model.elements[13].section_no)
        self.gen_model.model.elements[13].section_no = min(self.gen_model.model.elements[7].section_no,self.gen_model.model.elements[13].section_no)
        self.gen_model.model.elements[8].section_no = min(self.gen_model.model.elements[8].section_no,self.gen_model.model.elements[12].section_no)
        self.gen_model.model.elements[12].section_no = min(self.gen_model.model.elements[8].section_no,self.gen_model.model.elements[12].section_no)
        self.gen_model.model.elements[9].section_no = min(self.gen_model.model.elements[9].section_no,self.gen_model.model.elements[11].section_no)
        self.gen_model.model.elements[11].section_no = min(self.gen_model.model.elements[9].section_no,self.gen_model.model.elements[11].section_no)

        self.gen_model.model.elements[14].section_no = min(self.gen_model.model.elements[14].section_no,self.gen_model.model.elements[21].section_no)
        self.gen_model.model.elements[21].section_no = min(self.gen_model.model.elements[14].section_no,self.gen_model.model.elements[21].section_no)

        self.gen_model.model.elements[15].section_no = min(self.gen_model.model.elements[15].section_no,self.gen_model.model.elements[20].section_no)
        self.gen_model.model.elements[20].section_no = min(self.gen_model.model.elements[15].section_no,self.gen_model.model.elements[20].section_no)

        self.gen_model.model.elements[16].section_no = min(self.gen_model.model.elements[16].section_no,self.gen_model.model.elements[19].section_no)
        self.gen_model.model.elements[19].section_no = min(self.gen_model.model.elements[16].section_no,self.gen_model.model.elements[19].section_no)

        self.gen_model.model.elements[17].section_no = min(self.gen_model.model.elements[17].section_no,self.gen_model.model.elements[18].section_no)
        self.gen_model.model.elements[18].section_no = min(self.gen_model.model.elements[17].section_no,self.gen_model.model.elements[18].section_no)

        self.gen_model.model.elements[22].section_no = min(self.gen_model.model.elements[22].section_no,self.gen_model.model.elements[35].section_no)
        self.gen_model.model.elements[35].section_no = min(self.gen_model.model.elements[22].section_no,self.gen_model.model.elements[35].section_no)

        self.gen_model.model.elements[23].section_no = min(self.gen_model.model.elements[23].section_no,self.gen_model.model.elements[34].section_no)
        self.gen_model.model.elements[34].section_no = min(self.gen_model.model.elements[23].section_no,self.gen_model.model.elements[34].section_no)

        self.gen_model.model.elements[24].section_no = min(self.gen_model.model.elements[24].section_no,self.gen_model.model.elements[33].section_no)
        self.gen_model.model.elements[33].section_no = min(self.gen_model.model.elements[24].section_no,self.gen_model.model.elements[33].section_no)

        self.gen_model.model.elements[25].section_no = min(self.gen_model.model.elements[25].section_no,self.gen_model.model.elements[32].section_no)
        self.gen_model.model.elements[32].section_no = min(self.gen_model.model.elements[25].section_no,self.gen_model.model.elements[32].section_no)

        self.gen_model.model.elements[26].section_no = min(self.gen_model.model.elements[26].section_no,self.gen_model.model.elements[31].section_no)
        self.gen_model.model.elements[31].section_no = min(self.gen_model.model.elements[26].section_no,self.gen_model.model.elements[31].section_no)

        self.gen_model.model.elements[27].section_no = min(self.gen_model.model.elements[27].section_no,self.gen_model.model.elements[30].section_no)
        self.gen_model.model.elements[30].section_no = min(self.gen_model.model.elements[27].section_no,self.gen_model.model.elements[30].section_no)

        self.gen_model.model.elements[28].section_no = min(self.gen_model.model.elements[28].section_no,self.gen_model.model.elements[29].section_no)
        self.gen_model.model.elements[29].section_no = min(self.gen_model.model.elements[28].section_no,self.gen_model.model.elements[29].section_no)
