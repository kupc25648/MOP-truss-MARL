...
int_obj1 = np.sum(all_v) # Truss volume
int_obj2 = np.sum(all_dt) # Difference btw target geometry and current truss geometry
...
'''
for i in range(len(test.model.nodes)):
    print(abs(test.model.nodes[i].coord[1] - test.model.nodes[i].target))
